...
const Products = () => {
  ...
  const Loading = () => {
    return (
      <>
       <h1 style={{color:'black', fontSize:'100px',fontStyle:'italic',textShadow:'5px 5px  gold'}}>Loading....</h1>
      </>
    )
  }
    ...
    return (
      <>
         <div className='d-flex justify-content-center mb-7 pb-5'>
          ...
          <button className='btn btn-outline-dark ms-2' onClick={()=>filterProduct("men's clothing")}>Mens Clothing</button>
          <button className='btn btn-outline-dark ms-2' onClick={()=>filterProduct("women's clothing")}>Women Clothing</button>
